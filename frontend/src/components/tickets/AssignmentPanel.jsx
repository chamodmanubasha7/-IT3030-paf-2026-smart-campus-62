    ...
    <Card className="border-indigo-200/80 dark:border-indigo-900/50">
      ...
      <CardContent className="space-y-6">
        ...
        <div className="space-y-2">
          ...
          <select
            className="flex h-9 w-full max-w-md rounded-md border border-input bg-background px-3 py-1 text-sm text-slate-900 dark:text-slate-100"
            value={technicianId}
        ...
        <div className="space-y-2 border-t border-slate-200 pt-4 dark:border-slate-800">
          ...
          <div>
            ...
            <textarea
              id="st-notes"
              rows={3}
              className="mt-1 w-full max-w-md rounded-md border border-input bg-background px-3 py-2 text-sm text-slate-900 dark:text-slate-100"
        ...
        <div className="space-y-2 border-t border-slate-200 pt-4 dark:border-slate-800">
          ...
          <textarea
            ...
            className="w-full max-w-md rounded-md border border-input bg-background px-3 py-2 text-sm text-slate-900 dark:text-slate-100"
            value={rejectReason}
