          ...
          <SidebarMenu>
            {WORKSPACE_NAV.map((item) => (
              <SidebarMenuItem key={item.key}>
                ...
                >
                  <item.icon />
                  <span className="text-[15px] font-serif font-medium tracking-wide">{item.label}</span>
                </SidebarMenuButton>
              </SidebarMenuItem>
            ))}
          </SidebarMenu>
                  ...
                  <Collapsible open={isAccessOpen} onOpenChange={setIsAccessOpen}>
                    <CollapsibleTrigger asChild>
                      <SidebarMenuButton tooltip="Access Control">
                        <Users />
                        <span className="text-[15px] font-serif font-medium tracking-wide">User & Role Management</span>
